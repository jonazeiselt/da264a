...
Task t2(300, TASK_FOREVER, &ultraSensorTask);
...
/*
   If someone stands to close to painting. Every time loop enter, currentMillis is incremented.
   Loop execetues every 30ms ---> 10 seconds equals 333,333...
*/
void serialComUltraSensor() {
